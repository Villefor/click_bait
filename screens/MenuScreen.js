...
const MenuScreen = () => {
  ...
  return (
    <LinearGradient
      ...
      <Text style={styles.welcomeText}>Seja bem vindo a ClickBait, escolha a opção de depósito</Text>
      ...
      <View style={styles.friendContainer}>
        <TouchableOpacity onPress={() => navigation.navigate("Convide")} style={styles.buttons}>
